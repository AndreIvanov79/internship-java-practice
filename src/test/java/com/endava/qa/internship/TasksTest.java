...
import static com.endava.qa.internship.Tasks.*;
...
public class TasksTest {
    ...
    void getDuplicateCharactersTest() {
        assertEquals(new char[]{'a'}, getDuplicateCharacters("Java"));
        assertEquals(new char[]{'q', 'w', 'e', 'r', 't', 'y', 'u', 'i', 'o'}, getDuplicateCharacters("qwertyuiopoiuytrewq"));
        assertEquals(new char[]{}, getDuplicateCharacters(""));
        assertEquals(new char[]{}, getDuplicateCharacters(null));
    }
    ...
    @Test
    void sortTest() {
        assertEquals(new int[]{}, sort());
        assertEquals(new int[]{-11, -3, 9, 17, 42, 54, 54, 602, 999}, sort(42, 9, 17, 54, 602, -3, 54, 999, -11));
    }
